...
enum BpmnElements {
  ...
  StartTask = 'bpmn:startTask',
  ApprovalTask = 'bpmn:approvalTask',
  HandleTask = 'bpmn:handleTask',
  ArchiveTask = 'bpmn:archiveTask',
...
BpmnAdapter.shapeConfigMap.set(BpmnElements.StartTask, {
  width: StartTaskConfig.width,
  height: StartTaskConfig.height,
});
BpmnAdapter.shapeConfigMap.set(BpmnElements.ApprovalTask, {
  width: ApprovalTaskConfig.width,
  height: ApprovalTaskConfig.height,
});
BpmnAdapter.shapeConfigMap.set(BpmnElements.HandleTask, {
  width: HandleTaskConfig.width,
  height: HandleTaskConfig.height,
});
BpmnAdapter.shapeConfigMap.set(BpmnElements.ArchiveTask, {
  width: ArchivalTaskConfig.width,
  height: ArchivalTaskConfig.height,
});
